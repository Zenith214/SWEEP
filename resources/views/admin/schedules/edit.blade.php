                    ...
                    <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}" id="scheduleForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                @foreach($days as $dayValue => $dayName)
                                    @php
                                        $isChecked = is_array(old('days_of_week')) 
                                            ? in_array($dayValue, old('days_of_week'))
                                            : in_array($dayValue, $selectedDays);
                                    @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                value="{{ old('collection_time', $schedule->collection_time->format('H:i')) }}"
                                required
                            >
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small">
                        <li><strong>Route:</strong> {{ $schedule->route->name }}</li>
                        <li><strong>Zone:</strong> {{ $schedule->route->zone }}</li>
                    ...
                    <p class="small">The system will prevent updating schedules that conflict with existing schedules on the same route for the same days.</p>

                    <h6 class="mt-3">Important</h6>
                    <p class="small">Changes to this schedule will affect all future collections. Past collections are not modified.</p>
                </div>
            </div>
        </div>
    </div>
