...
<x-app-layout>
    ...
    <div class="mb-4">
        ...
        <h1 class="h2 mb-0">Add Holiday</h1>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.holidays.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    value="1"
                                    {{ old('is_collection_skipped', '1') == '1' ? 'checked' : '' }}
                            ...
                            <div class="form-check mt-2">
                                <input 
                                    ...
                                    value="0"
                                    {{ old('is_collection_skipped') == '0' ? 'checked' : '' }}
                                    onchange="toggleRescheduleDate()"
                                >
                        ...
                        <div class="mb-3" id="reschedule_date_field" style="display: {{ old('is_collection_skipped', '1') == '0' ? 'block' : 'none' }};">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Add Holiday
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Holidays affect waste collection schedules for all routes. When you add a holiday:
                    </p>
                    <ul class="small">
                    ...
                    <div class="alert alert-info small mb-0">
                        <i class="bi bi-lightbulb"></i> <strong>Tip:</strong> Holiday exceptions apply to all routes automatically.
                    </div>
                </div>
            </div>
        </div>
